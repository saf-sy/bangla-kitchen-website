export const menuData = {
  Appetizers: [
    { name: 'Chicken Samosa', price: '$1.99' },
    { name: 'Veggie Samosa', price: '$1.99' },
    { name: 'Tok-Jhal Chotpoti', price: '$7.99', note: 'Dhaka classic' },
    { name: 'Fuska', price: '$7.99' },
    { name: 'Haleem', price: '$9.99' },
    { name: 'BK Chicken Wrap w/ Fries', price: '$9.99' },
    { name: 'BK Burger w/ Fries', price: '$9.99' },
    { name: 'Petis', price: '$2.99' },
    { name: 'Chicken Corn Soup', price: '$5.99' },
  ],
  'Signature Dishes': [
    { name: 'Dhakaiya Kacchi Biryani', price: '$15.99', desc: 'Slow-cooked goat, Dhaka spices', star: true },
    { name: 'Chicken Biryani', price: '$11.99' },
    { name: 'Beef Tehari', price: '$12.99', desc: 'Basmati cooked with mustard oil' },
    { name: 'Roast Polao', price: '$12.99' },
    { name: 'Butter Chicken', price: '$10.99' },
    { name: 'Chicken Tikka with Naan', price: '$10.99' },
  ],
  'Fish & Vegetables': [
    { name: 'Hilsha Fish Curry with Rice', price: '$13.99' },
    { name: 'Ruhu Fish Curry', price: '$13.99' },
    { name: 'Channa Masala with Naan', price: '$9.99' },
    { name: 'Chole Batura', price: '$10.99' },
    { name: 'Palak Paneer', price: '$10.99' },
    { name: 'Mixed Veggies with Naan', price: '$7.99' },
  ],
  'Sweets & Drinks': [
